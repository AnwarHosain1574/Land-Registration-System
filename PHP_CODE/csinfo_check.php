<?php
    ...
    //$status = ;
	    ...
	    $status = 0;
			...
			$sql = mysqli_query($con,"INSERT INTO cs(user_id, district, subdistrict, mouja, ze_el_no, khatiyan_no, land_owner, land_quantity, land_address, status, comment) VALUES ('$userid', '$district', '$subdistrict', '$mouja', '$jlno', '$khatiyanno', '$landowner', '$landquantity', '$landaddress', '$status', '$comment')" ) ;
