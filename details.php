		...
		<div class="container">
			...
			<div class="main-container">
				<div class="content-wrapper">
					<?php require'ui/detailed_data.php';?>
				</div>
				<a href="request.php" class="btn btn-primary">Request</a><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<button href="request.php" class="btn btn-primary" id="verify">Verified</button>
			</div>
		</div>
